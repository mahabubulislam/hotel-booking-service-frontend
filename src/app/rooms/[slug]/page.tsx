...
const RoomDetails = ({ params }: { params: { slug: string } }) => {
  return (
    <main className='py-6 px-4 sm:p-6 md:py-20 md:px-8 bg-accent'>
      <div className='max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2'>
        ...
        <div className='mt-4 col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-3 lg:row-end-4'>
          <div className='flex flex-wrap items-center gap-5 mb-5 text-white'>
      ...
      <section className='my-10 text-white'>
        <h5 className='text-2xl my-3 text-secondary'>Similar Rooms</h5>
        <div className='grid grid-cols-1 md:grid:cols-2 lg:grid-cols-3 gap-10'>
          {[...Array(3)].map((room, index) => (
            <Room key={index} />
          ))}
        </div>
      </section>
